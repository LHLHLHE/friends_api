# Generated by Django 4.2.1 on 2023-05-04 14:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(blank=True, choices=[('sent', 'Заявка отправлена'), ('rejected', 'Заявка отклонена'), ('accepted', 'Заявка принята')], default='sent', max_length=150, verbose_name='Статус заявки')),
